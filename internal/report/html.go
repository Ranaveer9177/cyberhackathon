...
<body>
    <div class="report-wrapper">
        ...
        <header class="exec-header">
            <div class="brand-section">
                ...
                <div class="brand-text">
                    <h1>VibeGuard Security Report <span class="version-badge">v4.4.0</span></h1>
        ...
        <footer class="report-footer">
            <div>
                Generated autonomously by <strong>VibeGuard v4.4.0</strong> • Enterprise Pre-Push Security Gate
            </div>
            <div>
